...
%
%
\begin{question}{Tables Creation and Insertion / Tabelle Erstellen und Befüllen}%
...
\begin{itemize}%
\item Assume that the field \sqlil{airplane_type} is a foreign key to the table \sqlil{airplane_time} created by script \programUrl{airline_table_airplane_type} in \cref{lst:airline_table_airplane_type} in the previous question. %
...
Geben Sie ein Kommando an, dass die Tabelle auf vernünftige Art zu erstellen würde.%
\begin{itemize}%
\item Nehmen Sie an, dass das Feld \sqlil{airplane_type} ein Fremdschlüssel auf die Tabelle \sqlil{airplane_time} ist, die vom Skript \programUrl{airline_table_airplane_type} in \cref{lst:airline_table_airplane_type} in der vorigen Aufgabe erstellt wurde.%
...
\begin{itemize}%
\item Geben Sie ein Kommando an, dass die Tabelle auf vernünftige Art zu erstellen würde. %
\item Nehmen Sie an, das keine der Spalten optional ist.%
\end{itemize}%
\end{itemize}%
\end{question}%
...
\item \sqlil{airplane} be a foreign key referencing table \sqlil{pilot} created in one of the previous tasks and filled with data by script \cref{lst:airline_insert_airplane} in \programUrl{airline_insert_airplane}.%
\end{itemize}%
\end{itemize}%
\end{question}%
\begin{question}{}%
...
\item \sqlil{airplane} soll eine Fremdschlüssel-Referenz auf Tabelle \sqlil{pilot} erstellt in einer der vorigen Aufgaben und gefüllt mit Daten via Skript \cref{lst:airline_insert_airplane} in \programUrl{airline_insert_airplane} sein.%
\end{itemize}%
\end{itemize}%
\end{question}%
%
