...
\begin{question}{ERDs}%
\begin{center}%
\includegraphics[width=0.5\linewidth]{\currentDir/graphics/erdPerson1}%
\end{center}%
\begin{itemize}%
\item[DE] Erklären Sie alle Entitätstypen, Attribute, und Beziehungen in dem \glsShort{ERD} oben.%
\item[EN] Explain all entity types, attributes, and relationships in the \glsShort{ERD} above.%
\end{itemize}%
\end{question}%
%
\begin{question}{ERDs}%
...
\begin{question}{ERDs}%
\begin{center}%
\includegraphics[width=0.5\linewidth]{\currentDir/graphics/erdPersonStudentFaculty1}%
\end{center}%
\begin{itemize}%
\item[DE] Erklären Sie alle Entitätstypen, Attribute, und Beziehungen in dem \glsShort{ERD} oben.%
\item[EN] Explain all entity types, attributes, and relationships in the \glsShort{ERD} above.%
...
\begin{question}{ERDs}%
\begin{center}%
\includegraphics[width=0.5\linewidth]{\currentDir/graphics/erdStudent5}%
\end{center}%
\begin{itemize}%
\item[DE] Erklären Sie alle Entitätstypen, Attribute, und Beziehungen in dem \glsShort{ERD} oben.%
\item[EN] Explain all entity types, attributes, and relationships in the \glsShort{ERD} above.%
...
\begin{question}{ERDs}%
\begin{center}%
\includegraphics[width=0.5\linewidth]{\currentDir/graphics/erdPersonStudentFaculty2}%
\end{center}%
\begin{itemize}%
\item[DE] Erklären Sie alle Entitätstypen, Attribute, und Beziehungen in dem \glsShort{ERD} oben.%
\item[EN] Explain all entity types, attributes, and relationships in the \glsShort{ERD} above.%
...
\begin{question}{ERDs}%
\begin{center}%
\includegraphics[width=0.5\linewidth]{\currentDir/graphics/erdStudentModuleProf1}%
\end{center}%
\begin{itemize}%
\item[DE] Erklären Sie alle Entitätstypen, Attribute, und Beziehungen in dem \glsShort{ERD} oben.%
\item[EN] Explain all entity types, attributes, and relationships in the \glsShort{ERD} above.%
...
\begin{question}{ERDs}%
\begin{center}%
\includegraphics[width=0.5\linewidth]{\currentDir/graphics/erdRoom1}%
\end{center}%
\begin{itemize}%
\item[DE] Erklären Sie alle Entitätstypen, Attribute, und Beziehungen in dem \glsShort{ERD} oben.%
\item[EN] Explain all entity types, attributes, and relationships in the \glsShort{ERD} above.%
...
\begin{question}{ERDs}%
\begin{center}%
\includegraphics[width=0.5\linewidth]{\currentDir/graphics/erdStudent4}%
\end{center}%
\begin{itemize}%
\item[DE] Erklären Sie alle Entitätstypen, Attribute, und Beziehungen in dem \glsShort{ERD} oben.%
\item[EN] Explain all entity types, attributes, and relationships in the \glsShort{ERD} above.%
...
\begin{question}{ERDs}%
\begin{center}%
\includegraphics[width=0.5\linewidth]{\currentDir/graphics/erdPerson2}%
\end{center}%
\begin{itemize}%
\item[DE] Erklären Sie alle Entitätstypen, Attribute, und Beziehungen in dem \glsShort{ERD} oben.%
\item[EN] Explain all entity types, attributes, and relationships in the \glsShort{ERD} above.%
...
\begin{question}{ERDs}%
\begin{center}%
\includegraphics[width=0.5\linewidth]{\currentDir/graphics/erdModules1}%
\end{center}%
\begin{itemize}%
\item[DE] Erklären Sie alle Entitätstypen, Attribute, und Beziehungen in dem \glsShort{ERD} oben.%
\item[EN] Explain all entity types, attributes, and relationships in the \glsShort{ERD} above.%
...
\begin{question}{ERDs}%
\begin{center}%
\includegraphics[width=0.5\linewidth]{\currentDir/graphics/erdPerson4}%
\end{center}%
\begin{itemize}%
\item[DE] Erklären Sie alle Entitätstypen, Attribute, und Beziehungen in dem \glsShort{ERD} oben.%
\item[EN] Explain all entity types, attributes, and relationships in the \glsShort{ERD} above.%
...
\begin{question}{ERDs}%
\begin{center}%
\includegraphics[width=0.5\linewidth]{\currentDir/graphics/erdDeliverables1}%
\end{center}%
\begin{itemize}%
\item[DE] Erklären Sie alle Entitätstypen, Attribute, und Beziehungen in dem \glsShort{ERD} oben.%
\item[EN] Explain all entity types, attributes, and relationships in the \glsShort{ERD} above.%
...
\begin{question}{ERDs}%
\begin{center}%
\includegraphics[width=0.5\linewidth]{\currentDir/graphics/erdPerson3}%
\end{center}%
\begin{itemize}%
\item[DE] Erklären Sie alle Entitätstypen, Attribute, und Beziehungen in dem \glsShort{ERD} oben.%
\item[EN] Explain all entity types, attributes, and relationships in the \glsShort{ERD} above.%
...
\begin{question}{ERDs}%
\begin{center}%
\includegraphics[width=0.5\linewidth]{\currentDir/graphics/erdPlatform1}%
\end{center}%
\begin{itemize}%
\item[DE] Erklären Sie alle Entitätstypen, Attribute, und Beziehungen in dem \glsShort{ERD} oben.%
\item[EN] Explain all entity types, attributes, and relationships in the \glsShort{ERD} above.%
