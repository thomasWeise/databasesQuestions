...
\end{center}%
\begin{itemize}%
\item[DE] Erklären Sie alle Entitätstypen, Attribute, Beziehungen, sowie Beziehungskardinalitäten und -modalitäten, soweit vorhanden, in dem \glsShort{ERD} oben.%
\item[EN] Explain all entity types, attributes, relationships, as well as relationship cardinalities and -modalities (as far as defined) in the \glsShort{ERD} above.%
\end{itemize}%
\end{question}%
%
\begin{question}{ERDs}%
