...
\begin{questionENDE}{Keys}{Schlüssel}%
\qENDE{%
What are \emph{(cnadidate) keys} and \emph{primary keys} in the conceptual model? %
What is the difference between them?%
}{%
...
\inQuotes{%
Die Provinz Anhui hat eine Fläch von 140\decSep100~$km^2$ und eine Bevölkerung von über 61~Million Menschen. %
Die Stadt Hefei hat ein Bruttosozialprodukt von über 180~Milliarden USD und ist eines der Wissenschaftszentrn von China. %
